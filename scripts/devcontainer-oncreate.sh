...
export CLAP_HOST_TEMPLATE_BASE=/workspaces/clap-jules/tools/clap-host-template
...
export CLAP_HOST_TEMPLATE_PATH=$CLAP_HOST_TEMPLATE_BASE
export CLAP_HOST_PATH=/workspaces/clap-jules/clap-host-repo/builds
...
# CLAP Hostリポジトリの事前準備
if [ ! -d "$CLAP_HOST_TEMPLATE_BASE" ]; then
  git clone --recurse-submodules https://github.com/free-audio/clap-host.git "$CLAP_HOST_TEMPLATE_BASE"
  cd "$CLAP_HOST_TEMPLATE_BASE"
